...
static void event_handler_cb_wifi_setings_obj5(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_weather_settings_obj6(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void create_screen_settings() {
    ...
    lv_obj_set_scroll_dir(obj, LV_DIR_VER);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_state_bar(obj, getFlowState(flowState, 0), 12);
        }
        {
            // label_setings
            lv_obj_t *obj = lv_label_create(parent_obj);
...
void tick_screen_settings() {
    void *flowState = getFlowState(0, 2);
    (void)flowState;
    tick_user_widget_state_bar(getFlowState(flowState, 0), 12);
}
...
void create_screen_wifi_setings() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_wifi_setings_wifi_setings, LV_EVENT_ALL, flowState);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_wifi_setings_obj5, LV_EVENT_ALL, flowState);
...
void create_screen_weather_settings() {
    ...
    lv_obj_set_scroll_dir(obj, LV_DIR_VER);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_state_bar(obj, getFlowState(flowState, 0), 20);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
            lv_obj_set_pos(obj, 0, -4);
        ...
        }
        {
            ...
            lv_obj_set_style_border_width(obj, 1, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_add_event_cb(obj, event_handler_cb_weather_settings_obj6, LV_EVENT_ALL, flowState);
                    add_style_epaper_button(obj);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
...
void tick_screen_weather_settings() {
    void *flowState = getFlowState(0, 5);
    (void)flowState;
    tick_user_widget_state_bar(getFlowState(flowState, 0), 20);
    {
...
void create_screen_weather() {
    ...
    lv_obj_set_scroll_dir(obj, LV_DIR_NONE);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_bg_opa(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_border_width(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_state_bar(obj, getFlowState(flowState, 53), 24);
        }
        {
            lv_obj_t *obj = lv_label_create(parent_obj);
            objects.obj57 = obj;
...
void tick_screen_weather() {
    ...
    tick_user_widget_state_bar(getFlowState(flowState, 53), 24);
    {
...
static const char *object_names[] = { "main", "menu", "settings", "wifi_setings", "sleep_settings", "weather_settings", "weather", "obj0", "obj0__state_time", "obj0__state_wifi", "obj0__power_save", "obj1", "obj1__state_time", "obj1__state_wifi", "obj1__power_save", "obj2", "obj2__state_time", "obj2__state_wifi", "obj2__power_save", "obj3", "obj3__state_time", "obj3__state_wifi", "obj3__power_save", "obj4", "obj4__state_time", "obj4__state_wifi", "obj4__power_save", "img_settings", "img_weather", "wlan_settings", "switch_wlan", "sleep_settings_page", "weather_settings_page", "obj5", "message_reconnect", "sleep_settings_sw", "sleep_settings_min", "sleep_settings_con_2", "sleep_settings_con_3", "sleep_settings_con_4", "obj6", "chart_weather_forecast_temp", "current_time", "current_weekday", "current_date", "obj7", "obj8", "state_wifi_main", "power_save", "yiyan", "label_menu", "label_settings", "label_weather", "img_clock", "label_clock", "img_smart_home", "label_smart_home", "label_setings", "ssid", "obj9", "rssi", "obj10", "ip", "obj11", "mac", "obj12", "primary", "obj13", "auth_mode", "obj14", "bandwidth", "obj15", "sleep_settings_con", "sleep_settings_con_1", "weather_api_key", "weather_api_host", "panel_show_tcp_msg", "obj16", "obj17", "obj18", "forecast_weather", "panel_wait", "obj19", "obj20", "obj21", "obj22", "obj23", "obj24", "obj25", "obj26", "obj27", "obj28", "obj29", "obj30", "obj31", "obj32", "obj33", "obj34", "obj35", "obj36", "obj37", "obj38", "obj39", "obj40", "obj41", "obj42", "obj43", "obj44", "obj45", "obj46", "obj47", "obj48", "obj49", "obj50", "obj51", "obj52", "obj53", "obj54", "obj55", "obj56", "obj57" };
